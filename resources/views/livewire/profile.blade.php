                            ...
                            @if(auth()->id() == $user->id)
                                @if(isset($form['straight']))
                                    <div class="flex flex-row">
                                        <div wire:click="toggleStraight"
                                             class="cursor-pointer hover:text-blue-500 dark:hover:text-blue-500 border border-blue-500 rounded p-1 hover:bg-blue-100 dark:hover:bg-blue-900 w-full"
                                             title="{{ $form['straight'] == 1 ? 'Click to toggle to Gay' : 'Click to toggle to Straight' }}">
                                            {{ $form['straight'] == 1 ? 'Straight' : 'Gay' }}
                                        </div>
                                        <div wire:click="unsetStraight"
                                             class="cursor-pointer hover:text-red-500 dark:hover:text-red-500 border border-red-500 rounded p-1 hover:bg-red-100 dark:hover:bg-red-900 w-8 h-8 flex justify-center items-center ml-2"
                                             title="click to set to Bisexual">
                                            <div class="text-red-500">X</div>
                                        </div>
                                    </div>
                                ...
                                @else
                                    <div wire:click="toggleStraight"
                                        ...
                                        <div class="text-red-500">Bisexual</div>
                                    </div>
                                @endif
                            @else
                                Sexuality:
